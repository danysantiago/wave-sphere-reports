...
\todo[inline]{Add Level Shifters and recalculate power.  See if we can find a chart of Charge vs Voltage to determine the lower level of available charge to get a more real estimate}
